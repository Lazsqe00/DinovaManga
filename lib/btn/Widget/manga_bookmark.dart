...
Widget buildMangaList(BuildContext context) {
  ...
  return Obx(() {
    if (controller_bookmark.bookmarks.isEmpty) {
      return Center(
        child: Text(
    ...
    return ListView.builder(
      itemBuilder: (context, index) {
        MangaModel manga = controller_bookmark.bookmarks[index];
        return Slidable(
          ...
          endActionPane: ActionPane(
            ...
            children: [
              SlidableAction(
                onPressed: (context) {
                  controller_bookmark.bookmark(context, manga);
                },
      ...
      itemCount: controller_bookmark.bookmarks.length,
    );
  });
}
