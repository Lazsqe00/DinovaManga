          ...
          itemBuilder: (context, index) {
            ...
            return FutureBuilder(
                ...
                builder: (context, snapshot) {
                  ...
                  ChapterApiModel chapterAPI = snapshot.data!;
                  return Slidable(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        int currentIndex = detail.chapters.indexWhere((element) => element.chapterApiData==chapter.chapterApiData,);
                        Get.to(PageDocTruyen(chuong: chapter.chapterName, chapter: chapter, detail: detail, currentIndex: currentIndex));//nhấn 2 lần mới chuyển trang nên cập nhâật lại vị trí chương truyện
                      },
                      child: Card(
                        child: Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: .cover,
                                    image: NetworkImage(
                                        "${chapterAPI.domainCdn}/${chapterAPI.chapterPath}/${chapterAPI.chapterImage[2]}",
                                    )
                                )
                              ),
                            ),
...
void _xoa(BuildContext context, ChapterModel chapter, MangaDetail detail) async{
